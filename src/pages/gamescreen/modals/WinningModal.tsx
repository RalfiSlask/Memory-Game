...
const WinningModal = () => {
    ...
    const { navigateToMainMenu, restartGame, playersList, isSolo, moves, countdown } = context;
    ...
    const winningText = winnerList.length > 1 ? "It’s a tie!" : `Player ${winnerList[0] ? winnerList[0].player : ""} Wins!`;
    const gameOverText = isSolo ? "Game over! Here’s how you got on…" : "Game over! Here are the results...";

  return (
    <div className={`bg-[#F2F2F2] rounded-[10px] w-[327px] md:w-[654px] px-6 md:px-14 pb-6 md:pb-[69px] md:pt-[51px] pt-8 absolute z-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2`}>
        <WinningHeadings 
